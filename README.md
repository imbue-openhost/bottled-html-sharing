...
export OPENHOST_DOMAIN=https://your-space.host.imbue.com
```
...
curl -X POST \
  ...
  https://html-share.your-space.host.imbue.com/upload
```
...
```json
{
  "url": "https://html-share.your-space.host.imbue.com/shared/<token>/file.html",
  "token": "<token>",
  "filename": "file.html"
}
```
